...
base_path = "../DATA/original-balanced-filtered-fourier-normalizated/Movement"
...
folds = 5
all_metrics = {}
output_file = open("RandomForest2-metrics.txt", "w")
...
output_file.write("\n--------------------------------------\n")
output_file.write("\nRANDOM FOREST: INTENCIÓN DE MOVIMIENTO")
